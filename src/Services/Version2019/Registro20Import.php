...
use iEducar\Packages\Educacenso\Services\Version2019\Models\Registro20Model;
...
class Registro20Import implements RegistroImportInterface
{
    ...
    private function createDisciplines($schoolClass, $level, $school): void
    {
    ...
    private function createDisciplineAcademicYear($discipline, $level): void
    {
    ...
    private function createSchoolGradeDiscipline($school, $level, $discipline): void
    {
    ...
    private function createSchoolClassDiscipline(LegacySchoolClass $schoolClass, LegacyDiscipline $discipline): void
    {
